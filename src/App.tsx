...
import FormularioBlog from './pages/admin/FormularioBlog.tsx';
...
const AdminLayout = () => {
  ...
  return (
    <div className="d-flex" id="contenedor-admin">
      <nav className="p-3 bg-white border-end shadow-sm" style={{ minHeight: '100vh', width: '250px' }}>
        ...
        <ul className="nav flex-column">
          <li className="nav-item"><Link className="nav-link" to="/admin"><i className="bi bi-grid-fill me-2"></i><span>Principal</span></Link></li>
          <li className="nav-item"><Link className="nav-link" to="/admin/pedidos"><i className="bi bi-receipt me-2"></i><span>Pedidos</span></Link></li>
          <li className="nav-item"><Link className="nav-link" to="/admin/productos"><i className="bi bi-box-seam-fill me-2"></i><span>Productos</span></Link></li>
          <li className="nav-item"><Link className="nav-link" to="/admin/usuarios"><i className="bi bi-people-fill me-2"></i><span>Usuarios</span></Link></li>
          <li className="nav-item"><Link className="nav-link" to="/admin/blog"><i className="bi bi-pencil-square me-2"></i><span>Blog</span></Link></li>
